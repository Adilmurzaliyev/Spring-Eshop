package com.adil.springeshop.config;

import com.adil.springeshop.endpoint.GreetingEndpoint;
import com.adil.springeshop.endpoint.ProductsEndpoint;
...
public class WebServiceConfig {
	...
	public static final String NAMESPACE_GREETING = "http://adil.com/springeshop/ws/greeting";
	...
	public DefaultWsdl11Definition defaultWsdl11Definition() {
		...
		wsdl11Definition.setSchema(xsdGreetingSchema());//xsdSchema
		return wsdl11Definition;
	}

	@Bean("greetingSchema")//если на заработает убрать  "greetingSchema"
